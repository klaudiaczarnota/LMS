...
urlpatterns =[
        ...
        path('student-remove-course/<int:course_id>/<int:student_id>', views.remove_enrolled_student),
        ...
        path('student-status-updates/<int:student_id>/', views.StudentStatusUpdateListCreateView.as_view()),

        path('teacher-status-updates/<int:teacher_id>/', views.TeacherStatusUpdateListCreateView.as_view())
]