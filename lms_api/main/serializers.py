...
class TeacherSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields=['id','full_name','email','password','qualification','mobile_no','skills','profile_img','teacher_courses','skill_list','total_teacher_course','face_url','insta_url','twit_url','web_url','you_url', 'status_updates_teacher']
...
class StudentSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields=['id','fullname','email','password','username','interseted_categories','profile_img', 'status_updates_student']
    def __init__(self, *args, **kwargs):
...
class StudentStatusUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = models.StudentStatusUpdate
        fields = '__all__'

class TeacherStatusUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = models.TeacherStatusUpdate
        fields = '__all__'