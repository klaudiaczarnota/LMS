...
import AddTeacherStatusUpdate from './Teacher/AddTeacherStatusUpdate'
import StudentStatusUpdate from './User/StudentStatusUpdate'
import StudentNotifications from './User/StudentNotifications'
import TeacherNotifications from './Teacher/TeacherNotifications'
import AddStudentStatusUpdate from './User/AddStudentStatusUpdate'
...
import TeacherStatusUpdates from './Teacher/TeacherStatusUpdate'
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path='/teacher-status-update' element={<TeacherStatusUpdates />} />
        <Route path='/teacher-notifications' element={<TeacherNotifications />} />
        <Route path='/add-teacher-status-update' element={<AddTeacherStatusUpdate />} />
        <Route path='/student-status-update' element={<StudentStatusUpdate />} />
        <Route path='/add-student-status-update' element={<AddStudentStatusUpdate />} />
        ...
        <Route path='/student-detail/:student_id' element={<StudentDetail />} />
