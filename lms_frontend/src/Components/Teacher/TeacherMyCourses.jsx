        ...
        <div className='row'>
            ...
            <section className='col-md-9'>
                <div className='card'>
                    ...
                    <div className='card-body' className="table-responsive">
                        <table className='table table-striped table-hover'>
                            ...
                            <tbody>
                                {courseData.map((course,index) => 
                                    ...
                                    <td className='text-center'><Link to={`/enrolled-students/`+course.id} >&nbsp;{course.total_enrolled_students}  <i className="bi bi-people-fill"></i></Link></td> 
                                    <td className='text-center'>
                                        <Link to={`/edit-course/` +course.id} className='btn btn-secondary btn-sm ms-2  mb-2'><i className="bi bi-pencil-square"></i></Link>
                                        ...
                                        <button onClick={()=>handleDeleteClick(course.id)} className='btn btn-danger btn-sm ms-2 mb-2'><i className="bi bi-trash"></i></button>
                                    </td>
                                </tr>
                                )}
                            </tbody>
